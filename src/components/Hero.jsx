...
import profileImg from '../assets/mydp1111.png';
...
<div className="absolute right-0 top-0 h-[65vh] md:h-full w-full md:w-1/2 z-10 pointer-events-none">
  ...
  <img
    src={profileImg}
    alt=""
    className="w-full h-full object-cover opacity-60 translate-y-[25px] scale-[0.85]"
  />
      ...
      <div className="max-w-[90rem] mx-auto px-6 sm:px-12 lg:px-16 relative w-full flex flex-col md:block">
        ...
        >
          <div className="hidden md:flex items-center gap-4">
            ...
            <span className="text-sm font-medium text-gray-400 tracking-widest uppercase">Sagar Burman</span>
          </div>
  ...
  Full-stack developer focused on building <span className="text-gray-200">modern web applications, 
  AI-powered systems</span>, and practical solutions that solve real-world problems.
